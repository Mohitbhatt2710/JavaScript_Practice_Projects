class UI{
      ...
      <div class="card card-body mb-2" >
        ...
        <div class="row">
         ...
         <a href ="${repo.html_url}" target ="_blank"> ${repo.name}</a>
          ...
          <span class="badge badge-secondary mb-1 " >Watchers:${user.watchers_count}</span>
          <span class="badge badge-success mb-1" >Forks:${user.forks_count}</span>
  ...
  showAlert(message,className){
    ...
    // clear any remaining not found alerts 
